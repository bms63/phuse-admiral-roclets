...
@caption allows for clearer titles to be declared as seen in derive_vars_dt() 1.3. @info allows for more detailed descriptions per example. Finally, @code is the specific
...
section pertaining to the arguments to save some space and only showcase the sections generated for @caption, @info, @code. Again, you don't want to 
...
is also home to developer utilities and so houses the roclet extension functions. The rdx_roclet.R file contains
